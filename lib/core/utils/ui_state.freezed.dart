...
abstract class _Loading<T> implements UiState<T> {
...
abstract class _Success<T> implements UiState<T> {
...
class _$ErrorImpl<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'UiState<$T>.error(failure: $failure)';
  }
...
abstract class _Error<T> implements UiState<T> {
